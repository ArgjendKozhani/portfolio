  ...
  return (
    <div className="flex flex-col items-center px-4 pb-16 relative" style={{ minHeight: 'calc(100vh - 96px)', marginTop: '96px' }}>
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center flex-1 flex flex-col justify-center py-12">
        ...
        {/* Typed role */}
        <div className="min-h-[80px] flex items-center justify-center" style={{ marginBottom: '40px' }}>
          <ReactTyped
            className="text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-4xl md:text-6xl font-bold"
            strings={[
              "Frontend Developer",
              "React Specialist",
              "UI/UX Enthusiast",
        ...
        {/* Interests with typed animation */}
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
          <a
            href="#projects"
            className="group relative px-12 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-xl 
                     transform hover:scale-105 transition-all duration-300 
                     shadow-2xl hover:shadow-purple-500/50 text-base tracking-wide"
          >
            View My Work
          </a>
          <a
            href="#contact"
            className="group relative px-12 py-4 bg-transparent border-2 border-purple-500 text-purple-400 
      ...
      {/* Scroll indicator with animation - positioned at bottom */}
